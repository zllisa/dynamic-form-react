...
const QuestionNumber: React.FC<QuestionNumberProps> = (props) => {
    const [title,setTitle] = useState<string>(props.title||'数字')
    ...
    return (
        <div className={`question_number ${props.className ? props.className : ''} ${focus ? 'focus' : 'unfocus'}`}
            style={props.style}
        ...
        >
            ...
            <div className="body">
            <Input placeholder={tips} readOnly suffix={unit} type='number' />
            </div>
            {
